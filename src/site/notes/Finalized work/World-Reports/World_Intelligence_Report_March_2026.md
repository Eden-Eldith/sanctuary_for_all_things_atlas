...
```mermaid
graph LR
    A[13 Feb<br/>NATO Arctic Sentry<br/>Vol: 87.0] --> B[21 Feb<br/>Iran hardens facilities<br/>Oil surges 5.7%<br/>Vol: 86.1]
...
```mermaid
timeline
    title Claude — From Military Asset to National Security Threat
    3 Jan 2026 : Operation Absolute Resolve
               : Claude coordinates Maduro capture
               : Zero US casualties in 4.5 hours
    25 Feb : Pentagon moves to blacklist Anthropic
    27 Feb : Supply-chain risk designation
           : Trump orders agencies to cease use
           : Iran airspace closes same day
    28 Feb : Leaked Amodei memo
           : Iran strikes begin
           : Claude still used via Palantir
    6 Mar : Amodei public apology
          : Pentagon formalises designation
    9 Mar : Anthropic files two federal lawsuits
    12 Mar : Michael says Claude would "pollute" defence
```
